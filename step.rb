...
begin
  ...
  project_helper = ProjectHelper.new(params.bundle_ids, params.entitlements, params.team_id, params.codesign_identity, params.platform_name)
  ...
  profile_helper.ensure_profiles(params.distribution_type, auth.test_devices, true, params.min_profile_days_valid)
  ###
